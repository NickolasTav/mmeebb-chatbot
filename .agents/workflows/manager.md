...
1. **Leia a Tech Spec** indicada em `docs/specs/`.
...
4. **Numere sequencialmente**:
   - `docs/tasks/task-01-{{slug}}.md`
   - `docs/tasks/task-02-{{slug}}.md`
5. **Preencha o template completamente**:
   - Vincule à Spec de origem.
   - Defina o **Escopo do Commit** (ex: `excel-import`, `unipam-ra`, `mmeebb-engine`).
...
6. **Salve cada tarefa** em `docs/tasks/`.

## Saída Esperada

Arquivos Markdown numerados em `docs/tasks/`, cobrindo 100% dos requisitos da Spec, prontos para a esteira do **Agente Desenvolvedor**.
