...
public class RabbitMQConfig {
    ...
    /**
     * Reaproveita a configuracao padrao do Spring Boot (retry, concorrencia) e habilita
     * Observation para que cada @RabbitListener gere um span/traceId correlacionavel no log.
     */
    @Bean
